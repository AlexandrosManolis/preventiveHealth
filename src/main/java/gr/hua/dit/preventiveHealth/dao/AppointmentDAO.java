...
public interface AppointmentDAO {
    ...
    Boolean existUnrejectedAppointment(Integer specialistId, LocalDate date, String time);

    List<Object[]> availableOpeningHours(Integer specialistId, LocalDate date);

    List<Appointment> specialistPendingAppointment(Integer specialistId, LocalDate date);
